...
var profiles = [
    Profile(userName: "iJustine", profilePicture: "face-1", lastMsg: "Hi Kavsoft !!!", lastActive: "10:25 PM"),
    Profile(userName: "Jenna Ezarik", profilePicture: "face-2", lastMsg: "No March Event🥲", lastActive: "06:25 AM"),
    Profile(userName: "Kaviya", profilePicture: "face-3", lastMsg: "What's Up 🥳🥳🥳", lastActive: "11:25 AM"),
    Profile(userName: "Emily", profilePicture: "face-4", lastMsg: "Need to Record Doumentation", lastActive: "10:25 PM"),
    Profile(userName: "Julie", profilePicture: "face-5", lastMsg: "Simply Sitting", lastActive: "10:25 PM"),
    Profile(userName: "Steve", profilePicture: "face-6", lastMsg: "Lying :(((((", lastActive: "10:25 PM"),
]
